 ...
 *
 * Securitiza todos los endpoints del sistema de guías de despacho:
 *   - Rol "descarga"  → solo GET /api/guias/{numeroGuia}/descargar
 *   - Rol "admin"     → todos los demás endpoints de /api/guias/**
