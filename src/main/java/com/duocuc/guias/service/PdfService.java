...
/**
 * Servicio para generar PDFs de guías de despacho usando iText 7.
 */
@Slf4j
@Service
public class PdfService {
    ...
    /**
     * Genera el PDF de una guía de despacho.
     *
    ...
    public byte[] generarPdf(GuiaDespacho guia) {
        ...
        Paragraph subtitulo = new Paragraph("Sistema de Gestión de Pedidos y Generación de Guías de Despacho")
                .setFontSize(10)
                .setTextAlignment(TextAlignment.CENTER)
